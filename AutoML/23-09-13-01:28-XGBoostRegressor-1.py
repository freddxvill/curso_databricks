...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/2807085349109763).
...
input_data_path = mlflow.artifacts.download_artifacts(run_id="274bda96e01d4bc59e545093703830ea", artifact_path="data", dst_path=input_temp_dir)
...
supported_cols = ["median_income", "ocean_proximity", "longitude", "total_bedrooms", "population", "latitude", "total_rooms"]
...
num_imputers = []
num_imputers.append(("impute_mean", SimpleImputer(), ["latitude", "longitude", "median_income", "population", "total_bedrooms", "total_rooms"]))
...
numerical_transformers = [("numerical", numerical_pipeline, ["median_income", "longitude", "total_bedrooms", "population", "latitude", "total_rooms"])]
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/2807085349109763)
...
def objective(params):
  with mlflow.start_run(experiment_id="2807085349109763") as mlflow_run:
...
space = {
  "colsample_bytree": 0.7913746193426434,
  "learning_rate": 0.04895480538158414,
  "max_depth": 4,
  "min_child_weight": 19,
  "n_estimators": 2474,
  "n_jobs": 100,
  "subsample": 0.228366436196847,
  "verbosity": 0,
  "random_state": 45171446,
}
...
if shap_enabled:
    ...
    train_sample = X_train.sample(n=min(100, X_train.shape[0]), random_state=45171446).fillna(mode)

    # Sample some rows from the validation set to explain. Increase the sample size for more thorough results.
    example = X_val.sample(n=min(100, X_val.shape[0]), random_state=45171446).fillna(mode)
