...
# MAGIC %md
# MAGIC Tambien se pueden obtener los datos directamente de la tabla que creamos con el notebook de creación de tablas
# MAGIC

# COMMAND ----------

census_df = spark.sql("select * from hive_metastore.default.census_t")
